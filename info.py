...
class Config(object):
    ...
    OWNER    = int(os.environ.get("OWNER", 1414327092))  # ⚠️ Required
    SUDO = list(map(int, os.environ.get("SUDO", "1414327092", "6399386263").split()))  # ⚠️ Required
    # Web Response Config
...
☛ For e.g :- <code> @ </code> or <code> https:/t.me/akaChampu </code>
"""
...
Tʜɪs ʙᴏᴛ ɪs sᴏʟᴇʟʏ ᴄʀᴇᴀᴛᴇ ᴏʀ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ :- @TheChampu
"""
...
- 𝖢𝗋𝖾𝖺𝗍𝗈𝗋 : <a href=@itsMeShivanshu</a>
- 𝖫𝗂𝖻𝗋𝖺𝗋𝗒 : Pyrogram
- 𝖫𝖺𝗇𝗀𝗎𝖺𝗀𝖾 : 𝖯𝗒𝗍𝗁𝗈𝗇 𝟥
- 𝖣𝖺𝗍𝖺𝖡𝖺𝗌𝖾 : 𝖬𝗈𝗇𝗀𝗈𝖣𝖡
- 𝖡𝖮𝖳 𝖲𝖾𝗋𝗏𝖾𝗋 : 𝖠𝗇𝗒𝖶𝗁𝖾𝗋𝖾
